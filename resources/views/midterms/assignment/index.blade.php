            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item">
                    <a href="" style="color: #808080;" class="text-decoration-none">
                        {{ $midterm->groupSubject->subject->{'name_' . app()->getLocale()} }} - {{ $midterm->groupSubject->group->group_name }}
                    </a>
                </li>
        ...
        <div class="exam-container">
            <div class="exam-card-up-header">
                ...
                <button class="btn-create">
                    <a href="{{ route('midterms.assignment.create', $midterm->id) }}" class="text-white">
                ...
                <table class="exam-table">
                    ...
                    @forelse($midterm->assignments as $assignment)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('assignments.submissions', $assignment->id) }}"class="group-badge text-white">
                                    {{ $assignment->name }}
                                </a>

        ...
        <div class="col-md-12">
            <div class="card shadow-sm">
                ...
                <div class="card-header d-flex justify-content-between align-items-center" style="background-color: #2c3e50; color: #fff; padding: 20px 15px; min-height: 70px;">
                    <h3 class="mb-0 text-white" style="font-size: 20px;">Joriy nazorat uchun guruxlar royhati</h3>
                    
                    <!-- Search Input -->
                    <div class="plus d-flex justify-content-between align-items-center">
                        <form action="{{ route('journals.search') }}" method="GET" class="d-flex">
                    ...
                    <table class="table table-hover" style="font-size: 14px;">
                        ...
                        @foreach($groups as $group)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('adminJournal.groupSubject', $group->id) }}" class="badge" style="background-color: #483D8B; color: white; font-size: 12px;">
                                        {{ $group->group_name }}
                                    </a>
                                </td>

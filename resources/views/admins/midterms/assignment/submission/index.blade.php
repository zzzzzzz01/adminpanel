        ...
        <div class="container-main">
            <div class="group-card-up-header">
                ...
                <div>
                    ...
                    <span class="badge bg-success">Vazifa</span>
                </div>
            </div>
                    ...
                    @foreach($students as $student)
                        ...
                        <tr>
                            ...
                            @if($submission)
                                ...
                                @else
                                    <a href="{{ route('admin.submissions.show', ['group' => $group->id, 'midterm' => $midterm->id, 'assignment' => $assignment->id, 'submission' => $submission->id]) }}" class="badge bg-warning text-dark">
                                        Topshirdi ({{ $submission->created_at->format('d.m.Y H:i') }})
                                    </a>
                                @endif
                            @else

<div class="mb-5 wow slideInUp" data-wow-delay="0.1s">
    <div class="section-title section-title-sm position-relative pb-3 mb-4">
        <h3 class="mb-0">@lang('words.latest.news')</h3>
    </div>
    ...
    <div class="d-flex rounded overflow-hidden mb-3 border border-primary-subtle">
        ...
        <a href="{{ route('posts.show',['post'=>$post->id]) }}" class="h5 fw-semi-bold d-flex align-items-center bg-light px-3 mb-0">{{ $post->{'title_' . app()->getLocale()} }}</a>
    </div>
    @endforeach
</div>
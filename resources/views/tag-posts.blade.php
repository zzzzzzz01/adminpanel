...
<x-slot:title>
  Yangiliklar
    ...
    <a href="{{ route('posts.index') }}" class="btn btn-primary"> @lang('words.back') </a>
                            ...
                            <div class="blog-item bg-light rounded overflow-hidden border border-primary-subtle">
                                ...
                                <div class="p-4">
                                    <div class="d-flex mb-3">
                                        ...
                                        <small><i class="far fa-calendar-alt text-primary me-2"></i>{{ \Carbon\Carbon::parse($post->created_at)->format('d M, Y') }} </small>
                                    </div>

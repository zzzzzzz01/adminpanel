<x-layout.app>
    ...
    <div class="container-bot">
        <div class="card-up-header">
            <h1 class="text-white"><i class="fas fa-clock text-white"></i> Barcha Yakuniy Sessiyalar </h1>
            <p> O‘tkazilgan, davom etayotgan va rejalashtirilgan imtihonlar ro‘yxati </p>
        </div>
        
        <div class="controls">
            <div class="date-filter">
                <form action="{{ route('examSession.search') }}" method="GET">
                    ...
                    <input 
                            ...
                            style="min-width: 180px;"
                        >
                        @if(Route::is('examSession.search'))
                <a href="{{ route('examSession.all') }}" class="btn btn-secondary mb-1">
                    <i class="fas fa-times"></i> Bekor qilish
                </a>
            @endif
                    <button type="submit" class="btn btn-primary mb-1" id="filterBtn">
